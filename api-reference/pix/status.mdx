...
```javascript Node.js
const response = await fetch('https://api.primepix.me/v1/pix/status/12345', {
  headers: {
...
response = requests.get(
    'https://api.primepix.me/v1/pix/status/12345',
    headers={
        'X-API-Key': 'your_api_key',
        'X-API-Secret': 'your_api_secret'
    }
...
```php PHP
<?php
$ch = curl_init('https://api.primepix.me/v1/pix/status/12345');
